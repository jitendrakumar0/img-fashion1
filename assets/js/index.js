...
$('.popular').owlCarousel({
    ...
    navText: ["<img class='arrowimgp' src='./assets/img/icons8-chevron-left-30.png' class='img-fluid'>","<img class='arrowimgp' src='./assets/img/icons8-chevron-right-30.png'>"],
    responsive: {
        0: {
            items: 2,
        },
...
$('.arrivals').owlCarousel({
    ...
    autoplayHoverPause:true,
    smartSpeed: 1200,
    navText: ["<img class='arrowimga' src='./assets/img/icons8-chevron-left-30.png' class='img-fluid'>","<img class='arrowimga' src='./assets/img/icons8-chevron-right-30.png'>"],
    responsiveClass: true,
    responsive: {
        0: {
            items: 2,
